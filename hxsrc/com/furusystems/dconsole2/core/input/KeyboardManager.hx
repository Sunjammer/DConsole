package com.furusystems.dconsole2.core.input ;
	 ...
	 * @version 0.3
	 */
	 final class KeyboardManager extends EventDispatcher {
		/*  Variables */
		static var INSTANCE:KeyboardManager;
		var keyboardSource:InteractiveObject = null;
		 ...
		 * @return
		 */
		@:flash.property public static var instance(get,never):KeyboardManager;
static function  get_instance():KeyboardManager {
			if (INSTANCE == null) {
		 ...
		 */
		public function setup(eventSource:InteractiveObject) {
			try {
				//shutdown();
			} catch (e:Error) {
			}
		 ...
		 */
		public function addKeyboardShortcut(keystroke:UInt, modifier:UInt, callback:ASFunction, override:Bool = false):Bool {
		 ...
		 */
		public function removeKeyboardShortcut(keystroke:UInt, modifier:UInt):Bool {
		 ...
		 */
		public function removeAll(source:ASObject = null) {
			KeyboardSequences.instance.removeAll();
			KeyboardShortcuts.instance.removeAll();
		}
		 ...
		 */
		public function validateKeyboardShortcut(keystroke:UInt, modifier:UInt):Bool {
		 ...
		 */
		public function addKeyboardSequence(keyCodes:Array<ASAny>, callback:ASFunction, override:Bool = false):Bool {
		 ...
		 */
		public function removeKeyboardSequence(keyCodes:Array<ASAny>):Bool {
