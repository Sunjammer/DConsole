package com.furusystems.dconsole2.core.utils ;
	 ...
	 */
	 final class StringUtil {
		...
		public static function verboseToBoolean(input:String):Bool {
		...
		public static function multiTrim(value:String):String {
			return rtrim(new compat.RegExp("^([\\s|\\t|\\n]+)?(.*)([\\s|\\t|\\n]+)?$", "gm").replace(value, "$2"));
		}
		 ...
		 */
		public static function padNumber(n:ASObject, pad:Int = 2):String {
			var value= ASCompat.toString(n);
